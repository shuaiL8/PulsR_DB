...
var config = {
      "USER"     : "ec2-user",                  // if your database has user/pwd defined
      "PASS"     : "",
      "HOST"     : "ec2-54-157-40-239.compute-1.amazonaws.com",  // the domain name of our MongoDB EC2 instance
      "PORT"     : "27017",             // this is the default port mongoDB is listening for incoming queries
      "DATABASE" : "MongoDB"         // the name of your database on that instance
    };
